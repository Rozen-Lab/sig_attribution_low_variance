#!/bin/bash
PROJECT_DIR=/home/e0012078/packages/new_attr_code_fork
MSA_NF_FILE=common_code/MSA/run_auto_optimised_analysis.nf
DATA_DIR=analysis/raw_output/SBS/msa_default/syn/input/ColoRect-AdenoCA/non_msi
DATA_NAME=syn_data
OUTPUT_DIR=analysis/raw_output/SBS/msa_default/syn/output/ColoRect-AdenoCA/non_msi/raw
TOOL=conda
TYPE=SBS
